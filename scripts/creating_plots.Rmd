...
plot_bpm_at10 <- data_wide %>% 
  ...
  mutate(LGBT_inclusive_ever = recode(LGBT_inclusive_ever, `1` = "SGM", `0` = "Non-SGM"),
         reshist_state_so_factor_at10 = factor(reshist_state_so_factor_at10, c("0", "1")),
...
plot_1 <- ggplot(plot_bpm_at10, aes(x = reshist_state_so_factor_at10, y = Mean, fill = reshist_state_so_factor_at10)) +  
  ...
  theme(axis.text.x = element_blank(),
        ...
        plot.title = element_text(size = 8.5, hjust = 0.5, colour = "black", face = "bold"),
        strip.text = element_text(size = 6.5, color = "dark green", face = "bold"),
...
ggsave(filename = "../plots/BMP_state.png", width = 5, height = 4, dpi = 620)
```
...
ggsave("../plots/BMP_individual.png", width = 5, height = 4, dpi = 620)
```
...
round(c(p1_state_SI, p2_state_SI), 3)
```
...
ggsave("../plots/SI_state.png", width = 5, height = 4, dpi = 620)
```
...
ggsave("../plots/SI_individual.png", width = 5, height = 4, dpi = 620)
```
...
round(c(p1_state_SA, p2_state_SA), 3)
```
...
ggsave("../plots/SA_state.png", width = 5, height = 4, dpi = 620)
```
...
ggsave("../plots/SA_individual.png", width = 5, height = 4, dpi = 620)
```
