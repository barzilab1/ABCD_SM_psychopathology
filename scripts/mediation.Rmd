...
bpm_y_scr_totalprob_t_2 ~ b1*dim_yesno_q3_1 + c*LGBT_inclusive_ever_2tp + scale(age_year_2) + sex_br + race_black + race_white + ethnicity_hisp + scale(household_income_2) + dim_yesno_q1_ever + dim_yesno_q2_ever + dim_yesno_q4_ever + cybb_phenx_harm_2 + bully_vic_2
...
dim_yesno_q3_1 ~ a1*LGBT_inclusive_ever_2tp + scale(age_year_2) + sex_br + race_black + race_white + ethnicity_hisp  + scale(household_income_2) + dim_yesno_q1_ever + dim_yesno_q2_ever + dim_yesno_q4_ever + cybb_phenx_harm_2 + bully_vic_2

SI_y_2 ~ b1*dim_yesno_q3_1 + c*LGBT_inclusive_ever_2tp + scale(age_year_2) + sex_br + race_black + race_white + ethnicity_hisp  + scale(household_income_2) + dim_yesno_q1_ever + dim_yesno_q2_ever + dim_yesno_q4_ever + cybb_phenx_harm_2 + bully_vic_2
indirecteffectdiscrim := a1*b1
totaleffect := c + a1*b1
'
...
SA_y_2 ~ b1*dim_yesno_q3_1 + c*LGBT_inclusive_ever_2tp + scale(age_year_2) + sex_br + race_black + race_white + ethnicity_hisp  + scale(household_income_2) + dim_yesno_q1_ever + dim_yesno_q2_ever + dim_yesno_q4_ever + cybb_phenx_harm_2 + bully_vic_2
indirecteffectdiscrim := a1*b1
totaleffect := c + a1*b1
'
...
```{r}
set.seed(060822)
mod_cbcl_1Ms_long_addcov <- '
dim_yesno_q3_1 ~ a1*LGBT_inclusive_ever_2tp + scale(age_year_2) + sex_br + race_black + race_white + ethnicity_hisp  + scale(household_income_2) + dim_yesno_q1_ever + dim_yesno_q2_ever + dim_yesno_q4_ever + cybb_phenx_harm_2 + bully_vic_2

cbcl_scr_syn_totprob_t_2 ~ b1*dim_yesno_q3_1 + c*LGBT_inclusive_ever_2tp + scale(age_year_2) + sex_br + race_black + race_white + ethnicity_hisp  + scale(household_income_2) + dim_yesno_q1_ever + dim_yesno_q2_ever + dim_yesno_q4_ever + cybb_phenx_harm_2 + bully_vic_2
indirecteffectdiscrim := a1*b1
totaleffect := c + a1*b1
'

med_mod_cbcl_1Ms_long_addcov <- sem(mod_cbcl_1Ms_long_addcov, data = dataset_wide, se = "bootstrap", bootstrap = 500)

standardizedSolution(med_mod_cbcl_1Ms_long_addcov, type = "std.all") %>% htmlTable::htmlTable()

plot_mod_cbcl_1Ms_long_addcov <- lavaanPlot(
  model = med_mod_cbcl_1Ms_long_addcov,
  node_options = list(
    shape = "box",
    fontname = "Arial",
    color = "blue4"
...
summary(med_mod_cbcl_1Ms_long_addcov)
```
