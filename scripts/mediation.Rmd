...
dataset_wide$LGBT_inclusive_ever_2tp <- apply(dataset_wide[,grepl("LGBT_inclusive_bl|LGBT_inclusive_1", colnames(dataset_wide))],1 ,function(x) {any(x == 1)*1})
dataset_wide$LGBT_inclusive_ever_2tp = ifelse( (is.na(dataset_wide$LGBT_inclusive_ever_2tp) & 
                                                     (apply(dataset_wide[,which(grepl("LGBT_inclusive_bl|LGBT_inclusive_1", colnames(dataset_wide)))], 1, 
                                                            function(x) {any(x == 0)}))), 
