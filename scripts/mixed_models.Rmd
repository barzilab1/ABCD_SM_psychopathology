...
bpm_comb <- tab_model(bpm_mod_1, bpm_mod_2, bpm_mod_5, bpm_mod_6, show.intercept = F) #
bpm_comb
```
...
cbcl_comb <- tab_model(cbcl_mod_1, cbcl_mod_2, cbcl_mod_5, cbcl_mod_6, show.intercept = F)
cbcl_comb
```
...
SI_comb <- tab_model(SI_mod_1, SI_mod_2, SI_mod_5, SI_mod_6, show.intercept = F)
SI_comb
```
...
SA_comb <- tab_model(SA_mod_1, SA_mod_2, SA_mod_5, SA_mod_6, show.intercept = F)
SA_comb
```
