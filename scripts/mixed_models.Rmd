...
## AMONG SGM kids (sexual minority + transgender)
```{r}
# Table S6
# BPM
bpm_sens_mod_LGBT_inclusive_1 <- lmer(bpm_y_scr_totalprob_t ~ LGBT_inclusive + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white + 
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long)

bpm_sens_mod_LGBT_inclusive_2 <- lmer(bpm_y_scr_totalprob_t ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white + 
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long)

bpm_sens_mod_LGBT_inclusive_3 <- lmer(bpm_y_scr_totalprob_t ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic + 
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long,
...
bpm_sens_mod_LGBT_inclusive_4 <- lmer(bpm_y_scr_totalprob_t ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic +
                                        dim_yesno_q3*LGBT_inclusive + dim_yesno_q3*scale(reshist_state_so_factor) +
                                        scale(reshist_state_so_factor)*LGBT_inclusive + 
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long,
                                      control=lmerControl(check.nobs.vs.nlev = "ignore",
                                                          check.nobs.vs.rankZ = "ignore",
                                                          check.nobs.vs.nRE="ignore",
...
bpm_sens_mod_LGBT_inclusive_5 <- lmer(bpm_y_scr_totalprob_t ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic +
                                        dim_yesno_q3*LGBT_inclusive + dim_yesno_q3*scale(reshist_state_so_factor) +
                                        scale(reshist_state_so_factor)*LGBT_inclusive + 
                                        dim_yesno_q3*scale(reshist_state_so_factor)*LGBT_inclusive +
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long,
                                      control=lmerControl(check.nobs.vs.nlev = "ignore",
                                                          check.nobs.vs.rankZ = "ignore",
                                                          check.nobs.vs.nRE="ignore",
...
bpm_sens_comb <- tab_model(bpm_sens_mod_LGBT_inclusive_1, bpm_sens_mod_LGBT_inclusive_2, bpm_sens_mod_LGBT_inclusive_3, 
                           bpm_sens_mod_LGBT_inclusive_4, bpm_sens_mod_LGBT_inclusive_5, show.intercept = F)
bpm_sens_comb
```
...
# Table S7 (top)
# SI
SI_sens_mod_LGBT_inclusive_1 <- glmer(SI_y ~ LGBT_inclusive + age_year + age_year^2 + age_year^3 + sex_br + race_white + 
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long, family = binomial, nAGQ = 0)


SI_sens_mod_LGBT_inclusive_2 <- glmer(SI_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white + 
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long, family = binomial, nAGQ = 0)


SI_sens_mod_LGBT_inclusive_3 <- glmer(SI_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic + 
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long, family = binomial, nAGQ = 0)

SI_sens_mod_LGBT_inclusive_4 <- glmer(SI_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic +
                                        dim_yesno_q3*LGBT_inclusive + dim_yesno_q3*scale(reshist_state_so_factor) +
...
SI_sens_mod_LGBT_inclusive_5 <- glmer(SI_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic +
                                        dim_yesno_q3*LGBT_inclusive + dim_yesno_q3*scale(reshist_state_so_factor) +
...
SI_sens_comb <- tab_model(SI_sens_mod_LGBT_inclusive_1, SI_sens_mod_LGBT_inclusive_2, SI_sens_mod_LGBT_inclusive_3, 
                          SI_sens_mod_LGBT_inclusive_4, SI_sens_mod_LGBT_inclusive_5, show.intercept = F)
SI_sens_comb
```
...
# Table S7 (bottom)
# SA
SA_sens_mod_LGBT_inclusive_1 <- glmer(SA_y ~ LGBT_inclusive + age_year + age_year^2 + age_year^3 + sex_br + race_white + 
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long, family = binomial, nAGQ = 0)


SA_sens_mod_LGBT_inclusive_2 <- glmer(SA_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white + 
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long, family = binomial, nAGQ = 0)


SA_sens_mod_LGBT_inclusive_3 <- glmer(SA_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic + 
                                        (1 | site_id_l_br/rel_family_id/src_subject_id), data = dataset_long, family = binomial, nAGQ = 0)

SA_sens_mod_LGBT_inclusive_4 <- glmer(SA_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic +
                                        dim_yesno_q3*LGBT_inclusive + dim_yesno_q3*scale(reshist_state_so_factor) +
...
SA_sens_mod_LGBT_inclusive_5 <- glmer(SA_y ~ LGBT_inclusive + dim_yesno_q3 + scale(reshist_state_so_factor) + 
                                        age_year + age_year^2 + age_year^3 + sex_br + race_white +
                                        race_black + ethnicity_hisp + scale(income_resid) + reshist_addr1_adi_perc +
                                        dim_yesno_q1 + dim_yesno_q2 + dim_yesno_q4 + cybb_phenx_harm + bully_vic +
                                        dim_yesno_q3*LGBT_inclusive + dim_yesno_q3*scale(reshist_state_so_factor) +
...
SA_sens_comb <- tab_model(SA_sens_mod_LGBT_inclusive_1, SA_sens_mod_LGBT_inclusive_2, SA_sens_mod_LGBT_inclusive_3, 
                          SA_sens_mod_LGBT_inclusive_4, SA_sens_mod_LGBT_inclusive_5, show.intercept = F)
SA_sens_comb
```
